...
func (au *AccountUpdate) SetAccountOwner(s string) *AccountUpdate {
	au.mutation.SetAccountOwner(s)
	return au
}
...
func (au *AccountUpdate) SetNillableCurrency(s *string) *AccountUpdate {
	if s != nil {
		au.SetCurrency(*s)
	}
	return au
...
func (au *AccountUpdate) check() error {
	if v, ok := au.mutation.AccountOwner(); ok {
...
func (au *AccountUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := au.mutation.AccountOwner(); ok {
...
// SetAccountOwner sets the "account_owner" field.
func (auo *AccountUpdateOne) SetAccountOwner(s string) *AccountUpdateOne {
	auo.mutation.SetAccountOwner(s)
	return auo
}
...
// SetNillableCurrency sets the "currency" field if the given value is not nil.
func (auo *AccountUpdateOne) SetNillableCurrency(s *string) *AccountUpdateOne {
	if s != nil {
		auo.SetCurrency(*s)
	}
	return auo
...
func (auo *AccountUpdateOne) check() error {
	if v, ok := auo.mutation.AccountOwner(); ok {
		if err := account.AccountOwnerValidator(v); err != nil {
			return &ValidationError{Name: "account_owner", err: fmt.Errorf(`ent: validator failed for field "Account.account_owner": %w`, err)}
		}
	}
...
func (auo *AccountUpdateOne) sqlSave(ctx context.Context) (_node *Account, err error) {
	...
	if value, ok := auo.mutation.AccountOwner(); ok {
		_spec.SetField(account.FieldAccountOwner, field.TypeString, value)
	}
